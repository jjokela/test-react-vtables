...
const Row = memo(({ data, index, style }) => {
    ...
    return (
        <div onClick={() => toggleItemActive(index, item.word)} style={style}>
            {item.word} is {item.isActive ? 'active' : 'inactive'}
        </div>
    );
}, areEqual);
...
export default class ExampleWrapper extends PureComponent {
